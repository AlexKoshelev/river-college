...
const DisabledPhoneMenu = observer(({ isActive }) => {
  const toggleClassNameFontSise = (original, normal, medium, large) => {
        ...
        <div className="disabled__container">
          ...
          <div className="disabled__container-block">
            <div
              ...
              className={`${toggleClassNameFontSise(
...
export default DisabledPhoneMenu;
