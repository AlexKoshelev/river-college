    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          государственный университет водного транспорта» на 2023/24 учебный
          год.
        </p>
        ...
        <ul>
          ...
          <li>
            на <b>очно-заочную</b> получения образования – 15 сентября;
          </li>
          <li>
            на <b>заочную</b> форму получения образования – 17 ноября.
          </li>
        </ul>
        <p>
          <a
