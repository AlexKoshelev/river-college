    ...
    <div className="common__container">
      ...
      <ul>
        <a href={Ustav} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">Устав</li>
        </a>
      ...
      <ul>
        ...
        <a href={AkrVsuwtPril1} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">
            Приложение №1 к свидетельству о государственной аккредитации (ВГУВТ)
          </li>
        </a>
      ...
      <ul>
        <a href={PravPriem} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">Правила приема обучающихся</li>
        </a>
      ...
      <ul>
        <a href={Otchisl17} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">
            ...
            отношений между образовательной организацией и обучающимися и (или)
      ...
      <ul>
        <a href={KolDogov} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">Коллективный договор</li>
        </a>
      ...
      <ul>
        ...
        <a href={ZaklSanitar1} target={"_blank"} rel="noreferrer">
          <li className="doc__item active__link">
            ...
            среднего профессионального образования (с приложением) по адресу г.
            Уфа, ул. Ахметова, д. 275
          </li>
        </a>
