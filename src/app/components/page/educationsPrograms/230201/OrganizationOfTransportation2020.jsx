...
import rodn_yaz_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/rodn_yaz_op.pdf.sig";
import rodn_literatura_op from "../../../../assets/pdf/educationPage/230201/workPrograms/rodn_literatura_op.pdf";
import rodn_literatura_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/rodn_literatura_op.pdf.sig";
import fiz_kultura_op from "../../../../assets/pdf/educationPage/230201/workPrograms/fiz_kultura_op.pdf";
import fiz_kultura_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/fiz_kultura_op.pdf.sig";
import obgh_op from "../../../../assets/pdf/educationPage/230201/workPrograms/obgh_op.pdf";
import obgh_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/obgh_op.pdf.sig";
import astronomiya_op from "../../../../assets/pdf/educationPage/230201/workPrograms/astronomiya_op.pdf";
import astronomiya_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/astronomiya_op.pdf.sig";
import chimiya_op from "../../../../assets/pdf/educationPage/230201/workPrograms/chimiya_op.pdf";
import chimiya_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/chimiya_op.pdf.sig";
import obchestvoznanie_op from "../../../../assets/pdf/educationPage/230201/workPrograms/obchestvoznanie_op.pdf";
import obchestvoznanie_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/obchestvoznanie_op.pdf.sig";
import biologiya_op from "../../../../assets/pdf/educationPage/230201/workPrograms/biologiya_op.pdf";
import biologiya_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/biologiya_op.pdf.sig";
import geografiya_op from "../../../../assets/pdf/educationPage/230201/workPrograms/geografiya_op.pdf";
import geografiya_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/geografiya_op.pdf.sig";
import matematika_op from "../../../../assets/pdf/educationPage/230201/workPrograms/geografiya_op.pdf";
import matematika_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/geografiya_op.pdf.sig";
import informatika_op from "../../../../assets/pdf/educationPage/230201/workPrograms/informatika_op.pdf";
import informatika_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/informatika_op.pdf.sig";
import fizika_op from "../../../../assets/pdf/educationPage/230201/workPrograms/fizika_op.pdf";
import fizika_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/fizika_op.pdf.sig";
import osnov_filosof_op from "../../../../assets/pdf/educationPage/230201/workPrograms/osnov_filosof_op.pdf";
import osnov_filosof_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/osnov_filosof_op.pdf.sig";
import istoriya2_op from "../../../../assets/pdf/educationPage/230201/workPrograms/istoriya2_op.pdf";
import istoriya2_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/istoriya2_op.pdf.sig";
import inostr2_op from "../../../../assets/pdf/educationPage/230201/workPrograms/inostr2_op.pdf";
import inostr2_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/inostr2_op.pdf.sig";
import fiz_kultura2_op from "../../../../assets/pdf/educationPage/230201/workPrograms/fiz_kultura2_op.pdf";
import fiz_kultura2_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/fiz_kultura2_op.pdf.sig";
import matematika2_op from "../../../../assets/pdf/educationPage/230201/workPrograms/matematika2_op.pdf";
import matematika2_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/matematika2_op.pdf.sig";
import informatika2_op from "../../../../assets/pdf/educationPage/230201/workPrograms/informatika2_op.pdf";
import informatika2_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/informatika2_op.pdf.sig";
import ingener_grafika_op from "../../../../assets/pdf/educationPage/230201/workPrograms/ingener_grafika_op.pdf";
import ingener_grafika_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/ingener_grafika_op.pdf.sig";
...
import elektrotechnika_elektronika_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/elektrotechnika_elektronika_op.pdf.sig";
import metrolog_standart_sert_op from "../../../../assets/pdf/educationPage/230201/workPrograms/metrolog_standart_sert_op.pdf";
import metrolog_standart_sert_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/metrolog_standart_sert_op.pdf.sig";
import transp_syst_Rossii_op from "../../../../assets/pdf/educationPage/230201/workPrograms/transp_syst_Rossii_op.pdf";
import transp_syst_Rossii_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/transp_syst_Rossii_op.pdf.sig";
import techn_sredstva_op from "../../../../assets/pdf/educationPage/230201/workPrograms/techn_sredstva_op.pdf";
import techn_sredstva_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/techn_sredstva_op.pdf.sig";
import popd_op from "../../../../assets/pdf/educationPage/230201/workPrograms/popd_op.pdf";
import popd_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/popd_op.pdf.sig";
import ochrana_truda_op from "../../../../assets/pdf/educationPage/230201/workPrograms/ochrana_truda_op.pdf";
import ochrana_truda_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/ochrana_truda_op.pdf.sig";
import bezop_ghizned_op from "../../../../assets/pdf/educationPage/230201/workPrograms/bezop_ghizned_op.pdf";
import bezop_ghizned_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/bezop_ghizned_op.pdf.sig";
import PM01_org_perev_process_op from "../../../../assets/pdf/educationPage/230201/workPrograms/PM01_org_perev_process_op.pdf";
import PM01_org_perev_process_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/PM01_org_perev_process_op.pdf.sig";
import PM02_org_serv_obsl_op from "../../../../assets/pdf/educationPage/230201/workPrograms/PM02_org_serv_obsl_op.pdf";
import PM02_org_serv_obsl_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/PM02_org_serv_obsl_op.pdf.sig";
import PM03_org_trasp_logist_op from "../../../../assets/pdf/educationPage/230201/workPrograms/PM03_org_trasp_logist_op.pdf";
import PM03_org_trasp_logist_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/PM03_org_trasp_logist_op.pdf.sig";
import PM04_vipoln_rabot_op from "../../../../assets/pdf/educationPage/230201/workPrograms/PM04_vipoln_rabot_op.pdf";
import PM04_vipoln_rabot_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/PM04_vipoln_rabot_op.pdf.sig";
import russ_yaz_kul_rehi_op from "../../../../assets/pdf/educationPage/230201/workPrograms/russ_yaz_kul_rehi_op.pdf";
import russ_yaz_kul_rehi_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/russ_yaz_kul_rehi_op.pdf.sig";
import delov_inostr_op from "../../../../assets/pdf/educationPage/230201/workPrograms/delov_inostr_op.pdf";
import delov_inostr_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/delov_inostr_op.pdf.sig";
import osnov_delopr_op from "../../../../assets/pdf/educationPage/230201/workPrograms/osnov_delopr_op.pdf";
import osnov_delopr_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/osnov_delopr_op.pdf.sig";
import vnutr_vodn_puti_Rossii_op from "../../../../assets/pdf/educationPage/230201/workPrograms/vnutr_vodn_puti_Rossii_op.pdf";
import vnutr_vodn_puti_Rossii_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/vnutr_vodn_puti_Rossii_op.pdf.sig";
import org_dostup_sred_invalid_op from "../../../../assets/pdf/educationPage/230201/workPrograms/org_dostup_sred_invalid_op.pdf";
import org_dostup_sred_invalid_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/org_dostup_sred_invalid_op.pdf.sig";
import inform_techn_prof_deyat_op from "../../../../assets/pdf/educationPage/230201/workPrograms/inform_techn_prof_deyat_op.pdf";
import inform_techn_prof_deyat_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/inform_techn_prof_deyat_op.pdf.sig";
import kommerh_rabota_op from "../../../../assets/pdf/educationPage/230201/workPrograms/kommerh_rabota_op.pdf";
import kommerh_rabota_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/kommerh_rabota_op.pdf.sig";
import strach_riski_op from "../../../../assets/pdf/educationPage/230201/workPrograms/strach_riski_op.pdf";
import strach_riski_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/strach_riski_op.pdf.sig";
import ekonomika_upravl_op from "../../../../assets/pdf/educationPage/230201/workPrograms/ekonomika_upravl_op.pdf";
import ekonomika_upravl_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/ekonomika_upravl_op.pdf.sig";
import bortprovodnik_op from "../../../../assets/pdf/educationPage/230201/workPrograms/bortprovodnik_op.pdf";
import bortprovodnik_opSig from "../../../../assets/pdf/educationPage/230201/workPrograms/bortprovodnik_op.pdf.sig";
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <a href={rodn_yaz_op} target={"_blank"} rel="noreferrer">
                Родной язык
              </a>
            </td>
            <td>
              <a href={rodn_yaz_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={rodn_literatura_op} target={"_blank"} rel="noreferrer">
                Родная литература
              </a>
            </td>
            <td>
              <a
                href={rodn_literatura_opSig}
                target={"_blank"}
                rel="noreferrer"
              >
                ЭЦП
          ...
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={fiz_kultura_op} target={"_blank"} rel="noreferrer">
                Физическая культура
              </a>
            </td>
            <td>
              <a href={fiz_kultura_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={obgh_op} target={"_blank"} rel="noreferrer">
                Основы безопасности жизнедеятельности
              </a>
            </td>
            <td>
              <a href={obgh_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={astronomiya_op} target={"_blank"} rel="noreferrer">
                Астрономия
              </a>
            </td>
            <td>
              <a href={astronomiya_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={chimiya_op} target={"_blank"} rel="noreferrer">
                Химия
              </a>
            </td>
            <td>
              <a href={chimiya_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={obchestvoznanie_op} target={"_blank"} rel="noreferrer">
                Обществознание
              </a>
            </td>
            <td>
              <a
                href={obchestvoznanie_opSig}
                target={"_blank"}
                rel="noreferrer"
              >
                ЭЦП
          ...
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={biologiya_op} target={"_blank"} rel="noreferrer">
                Биология
              </a>
            </td>
            <td>
              <a href={biologiya_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={geografiya_op} target={"_blank"} rel="noreferrer">
                География
              </a>
            </td>
            <td>
              <a href={geografiya_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={matematika_op} target={"_blank"} rel="noreferrer">
                Математика
              </a>
            </td>
            <td>
              <a href={matematika_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={informatika_op} target={"_blank"} rel="noreferrer">
                Информатика
              </a>
            </td>
            <td>
              <a href={informatika_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
          <tr>
            ...
            <td>
              {" "}
              <PDF height={"25px"} width={"25px"} />
              <a href={fizika_op} target={"_blank"} rel="noreferrer">
                Физика
              </a>
            </td>
            <td>
              <a href={fizika_opSig} target={"_blank"} rel="noreferrer">
                ЭЦП
              </a>
            </td>
          </tr>
