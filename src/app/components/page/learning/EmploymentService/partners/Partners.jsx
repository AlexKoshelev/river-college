  ...
  return (
    <section>
      ...
      <p>
        ...
        <NavLink to="../vacanciesFrom"> работодателями</NavLink>, информирует их
        о выпускниках нашего филиала с целью их будущего трудоустройства. Тесная
        и плодотворная работа ведется с такими судоходными компаниями, как: ЗАО
        СК «БашВолготанкер», ООО «Речной порт «Бирск», ООО «Бельский район
        водных путей и судоходства», ООО «Судоремонтно-судостроительный завод»
        г. Уфа, ООО «Дельфин», ООО «Белый лебедь», ООО «Речфлот» и др.
      </p>
      <p>
